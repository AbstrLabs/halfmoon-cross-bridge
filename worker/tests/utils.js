...
async function depositOnNearTestnet(fromPrivKey, fromAddr, custodyAddr, amountInNEAR, toAlgoAddr) {
...
async function depositOnAlgoTestnet(fromPass, fromAddr, custodyAddr, amountInGoNEAR, toNEARAddr) {
