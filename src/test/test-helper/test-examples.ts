...
// TIPS: more example on http://localhost:4190/algorand-near?uid= (correct version hosted)
// const EXAMPLE_BURN_TXN_FROM_TEST_TABLE = {};

const EXAMPLE_BURN_TXN_FROM_DEV_TABLE = {
  dbId: 1,
