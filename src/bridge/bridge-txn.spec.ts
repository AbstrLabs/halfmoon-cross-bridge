import { EXAMPLE_BURN_TXN_FROM_DB } from '../test/test-helper/test-examples';
import { BridgeTxn } from './bridge-txn';

describe('Class BridgeTxn should', () => {
  it('equals between two instances with same attrs', () => {
    const bridgeTxn1 = BridgeTxn.fromObject(EXAMPLE_BURN_TXN_FROM_DB);
    const bridgeTxn2 = BridgeTxn.fromObject(EXAMPLE_BURN_TXN_FROM_DB);
